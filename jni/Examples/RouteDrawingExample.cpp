...
void RouteDrawingExample::Update(float dt)
{
    ...
    if(!m_createdRoutes)
    {
        ...
        //An arbitrarily selected default link speed for the route links.
        float linkSpeedMetersPerSecond = 25.f;
        ...
        //
        std::vector<RouteVertex> points = builder.Start(routeRed, halfWidth, linkSpeedMetersPerSecond, Routes::Road)
        ...
        std::vector<RouteVertex> otherPoints = builder.Start(routeBlue, halfWidth/2.f, linkSpeedMetersPerSecond, Routes::Road)
        ...
        std::vector<RouteVertex> islandCircuitPoints = builder.Start(routeGreen, halfWidth, linkSpeedMetersPerSecond, Routes::Road)
